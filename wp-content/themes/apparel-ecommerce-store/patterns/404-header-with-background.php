<?php
  ...
  * Slug: apparel-ecommerce-store/404-header-with-background
  */
?>
			...
			<div class="wp-block-cover__inner-container">
				...
				<div class="wp-block-group">
					...
					<div class="wp-block-group alignwide">
						...
						<h1 class="has-text-align-center has-text-color-foreground has-foreground-color has-text-color"><?php esc_html_e( '404 Nothing Found', 'apparel-ecommerce-store' ); ?></h1>
						<!-- /wp:heading -->
						<!-- wp:paragraph {"textAlign":"center"} -->
						<p class="has-text-align-center"><?php esc_html_e( 'Oops! That page can\'t be found', 'apparel-ecommerce-store' ); ?></p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
				</div>
